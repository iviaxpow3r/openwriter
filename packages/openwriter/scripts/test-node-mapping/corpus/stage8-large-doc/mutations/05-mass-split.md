...
Each one casts a long shadow forward into time.
...
Concurrency turns simple problems into combinatorial nightmares.

Two threads sharing a counter is harder than it looks.
